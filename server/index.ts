...
// Cargamos las variables de entorno (EMAIL_USER, EMAIL_PASS, etc.)
dotenv.config();
...
// --------------------- MIDDLEWARES ---------------------
// Permitir peticiones solo desde tu frontend en GitHub Pages
app.use(cors({
  origin: 'https://AdyaVP.github.io', // Reemplaza con tu URL si cambia
}));
